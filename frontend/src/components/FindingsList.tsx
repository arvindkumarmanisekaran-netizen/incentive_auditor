        ...
        <>
          <div className="finding-metrics">
            ...
            <div>
              ...
              <strong>
                {formatPercent(
                  e.cross_territory_share_percent
                )}
              </strong>
            </div>
          </div>
    ...
    default:
      return (
        <p className="muted-text">
          Detailed evidence is not available
          for this finding.
        </p>
      );
  }
    ...
    <section className="findings-section">
      <div className="section-heading">
        <div>
          <h2>Risk Signals</h2>
          <p>
            Deterministic indicators detected
