...
def investigate(
    ...
    if rows:
        ...
        if current_row and historical_rows:
            ...
            sales_analysis = calculate_sales_deviation(
            ...
            findings.append(
                {
                    ...
                    "severity": sales_analysis["severity"],
                    "evidence": sales_analysis,
                }
            )
    ...
    if mismatch_rows:
        ...
        if current_row and historical_rows:
            ...
            historical_prescription_average = (
                sum(float(row.prescription_quantity) for row in
                    historical_rows)
                / len(historical_rows)
            )

            mismatch_analysis = calculate_sales_prescription_mismatch(
            ...
            findings.append(
                {
                    ...
                    "severity": mismatch_analysis["severity"],
                    "evidence": mismatch_analysis,
                }
            )
    ...
    if doctor_rows:
        ...
        doctor_analysis = calculate_doctor_concentration(
            doctor_sales
        )
        ...
        findings.append(
            {
                ...
                "severity": doctor_analysis["severity"],
                "evidence": doctor_analysis,
            }
        )
        ...
        findings.append(
            {
                ...
                "severity": territory_analysis["severity"],
                "evidence": territory_analysis,
            }
        )
    ...
    if payout_row:
        difference = float(payout_row.payout_difference)

        if payout_row.expected_payout == 0 and payout_row.actual_payout > 0:
            severity = "HIGH"
